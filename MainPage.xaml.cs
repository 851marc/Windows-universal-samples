...
namespace CameraGetPreviewFrame
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async Task StartPreviewAsync()
        {
            ...
            //_mediaCapture.VideoDeviceController.Brightness.TrySetValue(30);
            //var a = _mediaCapture.VideoDeviceController.Focus.TrySetValue(1);
        ...
        private async Task SetPreviewRotationAsync()
        {
            ...
            //await _mediaCapture.VideoDeviceController.ExposureControl.SetValueAsync(100);
        ...
        private static async Task<DeviceInformation> FindCameraDeviceByPanelAsync(Windows.Devices.Enumeration.Panel desiredPanel)
        {
            ...
            DeviceInformation desiredDevice = allVideoDevices.FirstOrDefault(x => x.Name.Contains("LifeCam"));
